package com.darius.placebook.util
...
object ImageUtils {
    ...
    fun generateUniqueImageFile(context: Context): File {
    ...
    private fun rotateImage(img: Bitmap, degree: Float): Bitmap? {
        ...
        val rotatedImaged = Bitmap.createBitmap(img, 0, 0, img.width, img.height, matrix, true)
        img.recycle()
